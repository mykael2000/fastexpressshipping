...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-bold text-fes-navy">Create Static Page</h1>
    <a href="{{ route('admin.static-pages.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Back</a>
</div>

<div class="max-w-3xl">
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.static-pages.store') }}" class="space-y-5">
            @csrf

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Title <span class="text-red-500">*</span></label>
                <input type="text" name="title" value="{{ old('title') }}" id="page_title"
            ...
            <div>
                ...
                <input type="text" name="slug" value="{{ old('slug') }}" id="page_slug"
            ...
            <div>
                ...
                <textarea name="content" rows="16"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-fes-orange @error('content') border-red-400 @enderror">{{ old('content') }}</textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 border-t border-gray-100 pt-5">
                <div>
                    ...
                    <input type="number" name="nav_order" value="{{ old('nav_order', 0) }}" min="0"
                ...
                <div class="flex items-center gap-3 pt-6">
                    <input type="checkbox" name="show_in_nav" id="show_in_nav" value="1" {{ old('show_in_nav') ? 'checked' : '' }} class="rounded text-fes-orange">
            ...
            <div class="flex items-center gap-4 pt-2">
                <button type="submit" class="bg-fes-orange text-white font-semibold px-8 py-2.5 rounded-lg hover:bg-orange-600 transition">Create Page</button>
