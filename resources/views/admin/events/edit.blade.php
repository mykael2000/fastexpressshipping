...
@section('title', 'Edit Tracking Event')
@section('content')
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-bold text-fes-navy">Edit Tracking Event</h1>
    </div>
    <form method="POST" action="{{ route('admin.shipments.events.update', [$shipment, $event]) }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
        @csrf @method('PUT')
