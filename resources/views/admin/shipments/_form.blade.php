...
document.addEventListener("DOMContentLoaded", function () {
    ...
    <div>
        ...
        <select name="status" required class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-fes-orange @error('status') border-red-400 @enderror">
    ...
    <div>
        ...
        <select name="service_level" required class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-fes-orange @error('service_level') border-red-400 @enderror">
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Amount Currency</label>
        <input type="text" name="amount_currency" value="{{ old('amount_currency', $isEdit ? $shipment->amount_currency : '') }}"
            maxlength="10"
            class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-fes-orange @error('amount_currency') border-red-400 @enderror"
            placeholder="e.g. USD">
        @error('amount_currency')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
    </div>
